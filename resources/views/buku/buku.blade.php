...
<body>
    ...
    <div class="container-fluid fixed-top px-0 wow fadeIn" data-wow-delay="0.1s">
        ...
        <nav class="navbar navbar-expand-lg navbar-light py-lg-0 px-lg-5 wow fadeIn" data-wow-delay="0.1s">
            <a href="index.html" class="navbar-brand ms-4 ms-lg-0">
                <h1 class="fw-bold text-primary m-0">B<span class="text-secondary">oo</span>kpedia</h1>
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto p-4 p-lg-0">
                    ...
                    <a href="{{ url('/buku') }}" class="nav-item nav-link">Ebooks</a>
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle active" data-bs-toggle="dropdown">Category</a>
                        <div class="dropdown-menu m-0">
                            <a href="{{ url('/kategori') }}" class="dropdown-item">Novel</a>
                            <a href="{{ url('/kategori') }}" class="dropdown-item active">Komik</a>
                            <a href="{{ url('/kategori') }}" class="dropdown-item">Majalah</a>
                            <a href="{{ url('/kategori') }}" class="dropdown-item">Ensiklopedia</a>
                        </div>
                    </div>
    ...
    <div class="container-fluid page-header wow fadeIn" data-wow-delay="0.1s">
        <div class="container">
            <h1 class="display-3 mb-3 animated slideInDown">Books</h1>
        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-3 col-md-6">
                    <h1 class="fw-bold text-primary mb-4">B<span class="text-secondary">oo</span>kpedia</h1>
